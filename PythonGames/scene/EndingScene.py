...
class EndingScene(Scene):    
    def __init__(self):
        ...
        self.textTitle = self.textFont80.render("ENDING", True, (255,255,255))
        self.textFont40 = pygame.font.SysFont('MS Gothic', 40)
        self.textSTART = self.textFont40.render("PRESS SPACE KEY TO TITLE", True, (255,255,255))
        self.status = -1
        # Back Stars
        self.timerStar = random.random() * 0.1
        # BGM
        pygame.mixer.music.load(g.soundList['bgm clear'])
